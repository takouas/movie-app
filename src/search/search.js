    ...
    render() {
        ...
        return (
            <div className='box-search-type'>
                <span className='box-search-name'>  <i style={{ paddingTop: '15px' }} className="fa fa-search"></i>
                    <input className='search-style ' placeholder='search by name' onChange={this.props.SearchBar} />
